...
class Conta:
    ...
    def depositar(self: object, valor: float) -> None:
        if valor > 0:
            ...
            print('Erro ao efetuar depósito, por favor tente novamente.')

    def levantar(self: object, valor: float) -> None:
        if valor > 0 and self.saldo_total >= valor:
            ...
            print('Levantamento não realizado, tente novamente.')
